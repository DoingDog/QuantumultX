...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇺🇦": ["UA ","UA-","UA_","UA0","UA1","UA2","烏克蘭","乌克兰","基辅"],
    "🇭🇷": ["克罗地亚","HR ","HR-","HR_","HR0","HR1","HR2","克羅地亞"],
    "🇳🇬": ["尼日利亚","NG ","NG-","NG_","NG0","NG1","NG2","尼日利亞","拉各斯"],
    "🇸🇰": ["斯洛伐克","SK ","SK-","SK_","SK0"],
    "🇷🇸": ["RS ","RS-","RS_","RS0","RS1","RS2","塞尔维亚","塞爾維亞"],
    "🇲🇩": ["摩爾多瓦","MD ","MD-","MD_","MD0","MD1","MD2","摩尔多瓦"],
    "🇩🇰": ["DK ","DK-","DK_","DK0","DK1","DK2","DNK","丹麦","丹麥"],
    "🇪🇸": ["ES ","ES-","ES_","ES0","ES1","ES2","西班牙","Spain"],
    "🇫🇷": ["FR ","FR-","FR_","FR0","FR1","FR2","France","法国","法國","巴黎"],
    "🇬🇧": ["UK ","GB ","UK-","UK_","GB-","UK0","GB0","England","United Kingdom","英国","伦敦"],
    "🇲🇴": ["MO ","MO-","MO_","MO0","MO1","MO2","Macao","Macau","MAC","澳门","澳門","CTM"],
    "🇮🇩": ["ID ","ID-","ID_","ID0","ID1","ID2","Indonesia","印尼","印度尼西亚","雅加达"],
    "🇮🇳": ["India","IND","INDIA","印度","孟买","Mumbai","IN ","IN-","IN_","IN0"],
    "🇮🇸": ["IS ","IS-","IS_","IS0","IS1","IS2","ISL","冰岛","冰島"],
    ...
    "🇸🇬": ["SG","SG-","SG_","Singapore","SINGAPORE","新加坡","狮城","沪新","京新","泉新","穗新","深新","杭新","广新","廣新","滬新"],
    "🇯🇵": ["JP","JP-","JP_","Japan","JAPAN","日本","东京","大阪","埼玉","穗日","川日","中日","泉日","杭日","深日","辽日","广日"],
