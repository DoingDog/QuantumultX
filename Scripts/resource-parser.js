...
function get_emoji(emojip, sname) {
   var Lmoji = { 
    ...
    "🇳🇮": ["尼加拉瓜"],
    "🇴🇲": ["阿曼"," OM "],
    "🇮🇪": ["IE ","Ireland","IRELAND","爱尔兰","愛爾蘭","都柏林"],
    "🇧🇳": ["文莱","汶萊", "BRN","Negara Brunei Darussalam"],
    "🇨🇻": ["佛得角"],
    "🇸🇷": ["苏里南","蘇里南"],
    "🇲🇨": ["摩纳哥","摩納哥"],
    "🇯🇲": ["牙买加","牙買加 "],
    "🇧🇪": ["BE ","BE-","BE_","BE0","BE1","BE2","比利時","比利时"],
    "🇺🇦": ["UA ","UA-","UA_","UA0","UA1","UA2","烏克蘭","乌克兰","基辅","Ukraine"],
    "🇭🇷": ["克罗地亚","HR ","HR-","HR_","HR0","HR1","HR2","克羅地亞","Croatia"],
    "🇳🇬": ["尼日利亚","NG ","NG-","NG_","NG0","NG1","NG2","尼日利亞","拉各斯","Nigeria"],
    "🇸🇰": ["斯洛伐克","SK ","SK-","SK_","SK0","SK1","Slovakia"],
    "🇿🇦": ["ZA ","ZA-","ZA_","ZA0","South Africa","南非","Johannesburg"],
    "🇷🇼": ["RW ","RW-","RW_","RW0","Rwanda","卢旺达","盧旺達"],
    "🇨🇿": ["CZ ","CZ-","CZ_","CZ0","Czechia","捷克"],
    "🇧🇬": ["BG ","BG-","BG_","BG0","保加利亚","保加利亞","Bulgaria"],
    "🇷🇸": ["RS ","RS-","RS_","RS0","RS1","RS2","塞尔维亚","塞爾維亞","Seville","Sevilla"],
    "🇲🇩": ["摩爾多瓦"," MD ","MD-","MD_","MD0","MD1","MD2","摩尔多瓦","Moldova"],
    "🇩🇰": ["DK ","DK-","DK_","DK0","DK1","DK2","DNK","丹麦","丹麥","Denmark"],
    "🇪🇸": ["ES ","ES-","ES_","ES0","ES1","ES2","西班牙","Spain"],
    "🇫🇷": ["FR ","FR-","FR_","FR0","FR1","FR2","France","法国","法國","巴黎"],
    "🇬🇧": ["UK ","GB ","UK-","UK_","GB-","UK0","GB0","UK1","GB1","England","United Kingdom","英国","伦敦"," 英 ","Britain"],
    "🇲🇴": ["MO ","MO-","MO_","MO0","MO1","MO2","Macao","Macau","MAC","澳门","澳門","CTM"],
    "🇮🇩": ["ID ","IDN ","ID-","ID_","ID0","ID1","ID2","Indonesia","印尼","印度尼西亚","雅加达"],
    "🇮🇳": ["India","IND","INDIA","印度","孟买","Mumbai","IN ","IN-","IN_","IN0"],
    "🇮🇸": ["IS ","IS-","IS_","IS0","IS1","IS2","ISL","冰岛","冰島","Iceland"],
    "🇲🇽️": ["MEX ","MX ","MX-","MX_","MX0","MX1","MX2","墨西哥","Mexico","MEXICO"],
    "🇲🇾": ["MY ","MY-","MY_","MY0","MY1","MY2","Malaysia","MALAYSIA","大馬","大马","馬來西亞","吉隆坡","馬來","马来"],
    "🇳🇱": ["NL ","NL-","NL_","NL0","NL1","NL2","Netherlands","荷兰","荷蘭","尼德蘭","阿姆斯特丹"],
    "🇵🇭": ["PH ","PH-","PH_","PH0","PH1","PH2","Philippines","菲律宾","菲律賓"],
    "🇷🇴": ["RO ","RO-","RO_","RO0","RO1","RO2","罗马尼亚","Romania","Rumania", "羅馬尼亞"],
    "🇧🇾": ["BY ","BY-","BY_","BY0","BY1","BY2","白俄罗斯","白俄羅斯","White Russia","Republic of Belarus","Belarus"],
    "🇰🇵": ["KP ","KP-","KP_","朝鲜","North Korea","朝鮮"],
    "🇸🇪": ["SE ","SE-","SE_","SE0","SE1","SE2","Sweden","瑞典"],
    "🇹🇭": ["TH ","TH-","TH_","TH0","TH1","TH2","Thailand","泰国","泰國","曼谷"],
    "🇹🇷": ["TR ","TR-","TR_","TR0","TR1","TR2","TUR","Turkey","土耳其","伊斯坦布尔"],
    "🇻🇳": ["VN ","VN-","VN_","VN0","VN1","VN2","越南","胡志明市","Vietnam"],
    "🇮🇹": ["Italy"," IT ","IT-","IT_","IT0","IT1","IT2","Nachash","意大利","米兰","義大利"],
    "🇦🇪": ["United Arab Emirates","阿联酋","AE ","AE-","AE_","AE0","AE1","AE2","迪拜","Dubai", "阿聯酋"],
    "🇧🇷": ["BR ","BR-","BR_","BR0","BR1","BR2","Brazil","巴西","圣保罗"],
    "🇦🇷": ["AR ","AR-","AR_","AR0","AR1","AR2","Argentina","阿根廷"],
    "🇳🇴": ["Norway","挪威","NO ","NO-","NO_","NO0","NO1","NO2"],
    "🇵🇱": ["PL ","PL-","PL_","PL0","PL1","PL2","POL","波兰","波蘭","Porland"],
    "🇨🇾": ["CY ","CY-","CY_","CY0","CY1","CY2","塞浦路斯"],
    "🇪🇨": ["厄瓜多尔", "厄瓜多爾","EC ","EC-","EC_","EC0","EC1","EC2","Ecuador"],
    "🇲🇺": ["毛里求斯","Mauritius"],
    "🇵🇷": ["波多黎各","PR ","PR-","PR_","PR0","PR1","PR2"],
    "🇬🇹": ["危地马拉", "危地馬拉"," GT "],
    "🇨🇺": ["古巴"],
    "🇸🇲": ["圣马力诺","聖馬利諾"],
    "🇰🇾": ["开曼群岛","開曼群島"],
    ...
    "🇶🇦": ["卡塔尔","卡塔爾"," QA "],
    "🇸🇾": ["叙利亚","敘利亞"," SY "],
    "🇱🇧": ["黎巴嫩","LB ","LB-","LB_","LB0","LB1","LB2","Lebanon"],
    "🇱🇺": ["LU ","LU-","LU_","LU0","LU1","LU2","卢森堡", "盧森堡", "Luxembourg"],
    "🇭🇺": ["HU ","HU-","HU_","HU0","HU1","HU2","匈牙利","Hungary"],
    "🇭🇳": ["洪都拉斯"],
    "🇹🇬": ["多哥"],
    "🇵🇸": ["巴勒斯坦"],
    "🇬🇫": ["法屬圭亞那","法属圭亚那"],
    "🇹🇹": ["特立尼达和多巴哥","特立尼達和多巴哥"],
    "🇨🇭": ["CH ","CH-","CH_","CH0","CH1","CH2","瑞士","苏黎世","Switzerland"],
    "🇩🇪": ["DE ","DE-","DE_","DE0","DE1","DE2","German","GERMAN","德国","德國","法兰克福","京德","滬德","廣德","沪德","广德"],
    "🇬🇷": ["希腊","希臘","Greece","GR ","GR-","GR_","GR0","GR1","GR2"],
    "🇰🇷": ["KR ","KR-","KR_","KR0","KR1","KR2","Korea","KOR","韩国","首尔","韓","春川"],
    "🇷🇺": ["RU ","RU-","RU_","RU0","RU1","RU2","RUS","Russia","俄罗斯","毛子","俄国","俄羅斯","伯力","莫斯科","圣彼得堡","西伯利亚","新西伯利亚","京俄","杭俄","廣俄","滬俄","广俄","沪俄"],
    "🇦🇺": ["AU ","AU-","AU_","AU0","AU1","AU2","Australia","Sydney","澳大利亚","澳洲","墨尔本","悉尼","土澳","京澳","廣澳","滬澳","沪澳","广澳"],
    "🇨🇦": ["CA ","CA-","CA_","CA0","CA1","CA2","Canada","CANADA","CAN","Waterloo","加拿大","蒙特利尔","温哥华","楓葉","枫叶","滑铁卢","多伦多"],
    ...
    "🇸🇬": ["SG","SG-","SG_","Singapore","SINGAPORE","新加坡","狮城","獅城","沪新","京新","泉新","穗新","深新","杭新","广新","廣新","滬新"],
    "🇯🇵": ["JP","JP-","JP_","Japan","JAPAN","日本","东京","大阪","埼玉","京日","苏日","沪日","上日","穗日","川日","中日","泉日","杭日","深日","辽日","广日","Tokyo"],
    "🇭🇰": ["HK","Hongkong","Hong Kong","HongKong","HONG KONG","香港","深港","沪港","呼港","HKT","HKBN","HGC","WTT","CMI","穗港","京港"],
    "🏳️‍🌈": ["流量","套餐","剩余","重置","到期","时间","应急","过期","Bandwidth","expire","Expire","reset","Reset","traffic","Traffic"],
    "🇨🇳": ["CN","CN-","CN_","China","回国","中国","中國","江苏","北京","上海","广州","深圳","杭州","徐州","青岛","宁波","镇江","back"],
    "🇪🇺": ["EU","EU-","EU_","欧盟","欧罗巴","欧洲","European"],
    "🌏": ["亚洲","Asia"],
    "📺": ["流媒体","Netflix","NETFLIX","NF","视频","解锁"],
    "⚡️": ["DL","下载","大流量","大数据"],
    "🎮": ["GA","游戏"]
  }
